...
var _baiduMap = _interopRequireDefault(__webpack_require__(/*! ./pages/baiduMap/baiduMap.vue */ 114));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/* harmony import */ var _baiduMap_vue_vue_type_template_id_1f179fa6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./baiduMap.vue?vue&type=template&id=1f179fa6&scoped=true& */ 115);
/* harmony import */ var _baiduMap_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./baiduMap.vue?vue&type=script&lang=js& */ 117);
...
/* harmony import */ var _baiduMap_vue_vue_type_style_index_0_id_1f179fa6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./baiduMap.vue?vue&type=style&index=0&id=1f179fa6&scoped=true&lang=css& */ 120);
...
var _map = __webpack_require__(/*! @/common/map.js */ 119); //
//
//
//
//
...
//
//
var bmap = null;var _default = { data: function data() {return { ak: '5rXsow7CemWRLSPVdzgdnslItkTSy2fC', lat: 0, lng: 0, address: '', searchText: '', timer: null, addressList: [], isSearch: false, latitude: 23.58546, longitude: 113.509446, markers: [], system: '', systemHeight: 0, _mapContext: null };
  },
          ...
          if (this.getStatus() == BMAP_STATUS_SUCCESS) {
            ...
            bmap.addEventListener('click', function (event) {
              ...
              geoc.getLocation(clickPoint, function (rs) {
                ...
                var infoWindow = new BMapGL.InfoWindow("".concat(self.address), options);
